...
public class Login extends JFrame implements ActionListener {
    ...
    Login(){
        ...
        l1 = new JLabel("Добро пожаловать в банкомат");
        ...
        b3 = new JButton("Зарегистрироваться");
    ...
    public void actionPerformed(ActionEvent ae) {
        try{
            if(ae.getSource()==b1){
                ...
                ResultSet rs = statement.executeQuery("select * from login where cardno = '"+cardno+"' and pin = '"+pin+"'");
                if(rs.next()){
                    setVisible(false);
                    new Transactions(pin).setVisible(true);
                }else{
                    JOptionPane.showMessageDialog(null, "Неправильный PIN or Card Number");
                }
